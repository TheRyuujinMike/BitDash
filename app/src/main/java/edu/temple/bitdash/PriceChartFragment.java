...
public class PriceChartFragment extends Fragment {
    ...
    public void onViewCreated(View view, Bundle savedInstanceState) {
        ...
        RadioButton oneDay = (RadioButton) getView().findViewById(R.id.one_day);
        RadioButton fiveDay = (RadioButton) getView().findViewById(R.id.five_day);
        ImageView chart = (ImageView) getView().findViewById(R.id.current_chart);

        if (oneDay.isChecked()) {

            loadImage(1);

        } else if (fiveDay.isChecked()){
    ...
    private void loadImage(int days)
    {
        ...
        File myPath = new File(directory,"chart_" + dayString + "d.png");
        ...
        ImageView img=(ImageView) getView().findViewById(R.id.current_chart);
    ...
    public void onCreateOptionsMenu(Menu menu, MenuInflater inflater) {
        inflater.inflate(R.menu.pricechart_menu, menu);
